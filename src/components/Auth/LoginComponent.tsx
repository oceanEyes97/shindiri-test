  ...
  return (
    <div className="h-screen w-full bg-login-back bg-cover bg-center">
      <div className="flex h-full w-full items-center justify-center backdrop-brightness-50">
        <form onSubmit={handleLogin} className="w-full max-w-96 rounded-xl bg-black/50 p-5 md:w-1/2 md:max-w-xl">
          ...
          <div className="py-2 text-center text-white">
            ...
            <Link to="/reset-password" className="text-green-400 hover:text-green-600">Reset Password</Link>
          </div>

          <Button type="submit" className="mt-2 w-full bg-green-400 text-white hover:bg-green-600">Login</Button>
